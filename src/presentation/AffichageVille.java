...
public class AffichageVille extends JPanel 
{
	...
	public void paintComponent(Graphics g)
	{
		...
		// Affichage des clients. Ils sont représentés par des points rouges
		g2D.setColor(Color.red);
		for(Point2D.Double pos : listeClients)
		{
			if(pos != null)
				g2D.fillOval((int) ((pos.getX() - tailleBasePoint / 2) * scale + this.getWidth() / 2),(int) ((pos.getY() - tailleBasePoint / 2) * scale + this.getHeight() / 2), (int)(tailleBasePoint * scale), (int)(tailleBasePoint * scale));
		}
