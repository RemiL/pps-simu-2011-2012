...
/**
 * Des onglets pour les différentes simulations avec pour chacun un formulaire pour rentrer les paramètres de la simulation
 */
...
{	
	...
	/** Les champs des paramètres avec leurs valeurs pour la configuration de la recherche du nombre de taxis */
	private HashMap<String, JTextField> champsValeurs1;
	/** Les champs des paramètres avec leurs valeurs pour la configuration du calcul du pourcentage */
	private HashMap<String, JTextField> champsValeurs2;
	
	/**
	 *  Construit un affichage pour rentrer les paramètres sous forme de deux onglets.
	 *  Le premier pour paramétrer la recherche du nombre de taxis à avoir pour prendre en charge un certain pourcentage de clients.
	 *  Le second pour paramétrer le calcul du pourcentage de clients pris en charge par un certain nombre de taxis.
	 */
